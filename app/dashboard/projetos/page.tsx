...
export default async function ProjetosPage() {
  ...
  return (
    <>
      <PageHeader title="Projetos" description="Acompanhe a execução depois que a proposta for aceita: objetivo, prazo, status e proposta vinculada." />
