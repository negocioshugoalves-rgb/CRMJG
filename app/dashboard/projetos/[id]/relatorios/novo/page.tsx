  ...
  return (
    <>
      ...
      <form action={createRelatorio} className="document-page space-y-6">
        ...
        <div className="space-y-1.5"><label className="label" htmlFor="pontos_atencao">Pontos de atencao</label><textarea className="document-field min-h-40" id="pontos_atencao" name="pontos_atencao" /></div>
        <div className="space-y-1.5"><label className="label" htmlFor="proximos_passos">Proximos passos</label><textarea className="document-field min-h-40" id="proximos_passos" name="proximos_passos" /></div>
