  ...
  return (
    <>
      ...
      <form action={createPlanoAcao} className="document-page space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row"><button className="btn-primary" type="submit">Salvar ação</button><Link className="btn-secondary" href={`/dashboard/empresas/${empresa.id}/plano-acao`}>Cancelar</Link></div>
      </form>
    </>
  )
}
