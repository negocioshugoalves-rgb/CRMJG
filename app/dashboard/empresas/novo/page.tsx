...
export default function NovaEmpresaPage() {
  return (
    <>
      <PageHeader title="Nova empresa" description="Cadastre a empresa em uma tela limpa. Depois abra o dossiê para conduzir todo o fluxo consultivo." />
      ...
      <form action={createEmpresa} className="document-page space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5"><label className="label" htmlFor="porte">Porte</label><select className="document-field" id="porte" name="porte"><option value="">Não informado</option><option>Pequena</option><option>Media</option><option>Grande</option></select></div>
          ...
          <div className="space-y-1.5 sm:col-span-2"><label className="label" htmlFor="observacoes">Observações</label><textarea className="document-field min-h-32" id="observacoes" name="observacoes" /></div>
        </div>
