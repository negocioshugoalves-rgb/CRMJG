...
export default async function PlanosAcaoPage() {
  ...
  return (
    <>
      <PageHeader title="Planos de acao" description="Uma visao por empresa. Clique no card para abrir todas as acoes planejadas do dossie." />
